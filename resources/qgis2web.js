...
map.getView().fit([15647777.988294, -545402.369258, 15659415.745977, -540290.361262], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA JARINGAN TRANSPORTASI KAWASAN PERKOTAAN OKSIBIL</h2>';
        return titleElement;
    })(),
